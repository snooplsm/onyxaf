...
class ReviewSettingsBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        b.recyclerView.addItemDecoration(
            SpaceItemDecoration(
            lastBottom = resources.getDimension(R.dimen.five)*10
        )
        )
        ...
        vm.percentage.observe(viewLifecycleOwner, Observer {
            it?.consume()?.let {
                b.percentage.text = "$it%"
                b.write.hide()
            }
...
class BikeProgrammedBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_bike_programmed, container, false)
    }

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val dialog = super.onCreateDialog(savedInstanceState) as BottomSheetDialog

        val behav = dialog.behavior
